...
namespace Ingenica_WebAPI.DynamicsNAVWS {
    ...
    public partial class WebHookTest : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public void ProcessRequest(string p_MessageIn, ref string p_MessageOut) {
            object[] results = this.Invoke("ProcessRequest", new object[] {
                        p_MessageIn,
                        p_MessageOut});
            p_MessageOut = ((string)(results[0]));
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("urn:microsoft-dynamics-schemas/codeunit/WebHookTest:Ping", RequestNamespace="urn:microsoft-dynamics-schemas/codeunit/WebHookTest", ResponseElementName="Ping_Result", ResponseNamespace="urn:microsoft-dynamics-schemas/codeunit/WebHookTest", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void Ping() {
